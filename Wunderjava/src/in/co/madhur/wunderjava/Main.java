...
public class Main
{
	...
	private static String username = "gundermann.niels.ng@googlemail.com";
	private static String password = "01562979";
...
//		
		try
		{
			...
			WTask task=wunderList.CreateTask(list.getId(), "Test Task24556", "", "");
			
			System.out.println("Created task with id " + task.getId());
			
			System.out.println("deleting task");
			
			wunderList.DeleteList(task.getId());
